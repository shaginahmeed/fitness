          ...
          <div className="container-fluid">
            <div className="row align-items-center">
              <div className="col-xl-2 col-lg-2 col-md-1">
                <div className="logo">
                  <Link to="/">
                    <img id="title-image" src={logo} alt="RELIFE" />
                  </Link>
                </div>
              </div>
                      ...
                      <ul id="navigation">
                        ...
                        <li>
                          ...
                          <ul className="submenu">
                            <li>
                              <Link to="/workoutLog">Log Workout</Link>
                            </li>
                            <li>
                              <Link to="/foodLog">Log Food</Link>
                            </li>
                            <li>
                              <Link to="/waterLog">Log Water</Link>
                            </li>
                        ...
                        <li>
                          ...
                          <ul className="submenu">
                            <li>
                              <Link to="/caloriesBurnt">Calories Burnt</Link>
                            </li>
                            {/* <li><Link to="/workoutMinutes">Workout Minutes</Link></li> */}
                            <li>
                              <Link to="/waterIntake">Water Intake</Link>
                            </li>
                            <li>
                        ...
                        <li>
                          ...
                          <ul className="submenu">
                            <li>
                              <Link to="/searchMusic">Search Music</Link>
                            </li>
                            <li>
                              <Link to="/recommendedMusic">
